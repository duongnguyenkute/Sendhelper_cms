...
// Define the interface for a single tip
interface HomeTip {
  title: string;
  slug: string;
  summary: string;
  ...
  category: string;
  url: string;
  img: string; // Added img field
}

// Simulated API data
const homeTipsData: HomeTip[] = [
  {
...
const HomeTip = () => {
  ...
  return (
    <div className="px-[5%] py-8">
      <div className="py-8">
        <h2 className="text-2xl font-bold text-gray-800">Home Tips</h2>
      </div>
        ...
        {tips.map((tip) => (
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-2">
              Published: {new Date(tip.published_date).toLocaleDateString()}
            </p>
          </div>
        ))}
      </div>
